...
document.addEventListener("DOMContentLoaded", () => {
  ...
  let greeting = cfg.defaultGreeting;
  if (guestCode && cfg.guests[guestCode]) {
    greeting = cfg.guests[guestCode].name;
  } else if (rawName) {
    greeting = decodeURIComponent(rawName);
  }
  document.getElementById("guestGreeting").textContent = `Trân trọng kính mời: ${greeting}`;
